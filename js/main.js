    ...
    if (goods.length) {
        ...
        for (let i = 0; i < goods.length; i++) {
            ...
            <tr class="align-middle">
                ...
                <td>${goods[i][3]}</td>
                <td><button class="good_delete btn-primary" data-delete="${goods[i][0]}" style="background-color: red;color: white;">&#10006;</button></td>
                <td><button class="good_delete btn-primary" data-goods="${goods[i][0]}" style="background-color: #00a2ff;color: white;">&#10149;</button></td>
            </tr>
            `
            )
            if (goods[i][4] > 0) {
                ...
                <tr class="align-middle">
                    ...
                    <td>${goods[i][6]}</td>
                    <td><button class="good_delete btn-danger" data-delete="${goods[i][0]}" style="background-color: red;color: white">&#10006;</button></td>
                </tr>                
                `
                )
            }
